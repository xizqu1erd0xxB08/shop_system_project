...
// Validar POST del formulario con el product_id que necesitaremos para reactivar la tarea
...
$reactivate_product = $product->reactivateProduct($product_id, $user_id); // Llamar al método $reactivate_product

// Verificar que el método se haya ejecutado correctamente
if (!$reactivate_product['success']) {
    $database->closeConnection();
    die($reactivate_product['errorMessage']);
}

// Todo OK
$database->closeConnection();
header("Location: viewDeletedProductsController.php");
?>